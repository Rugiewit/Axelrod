...
test_strategies = [ Random, DeepQLearner, TitForTat, MediocreQLearner]

paper_strategies = [Cooperator, Defector, TitForTat, MediocreQLearner, DeepQLearner,Adaptive, RiskyQLearner, Grudger, Random, Alternator]
